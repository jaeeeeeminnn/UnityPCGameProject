...
public class PlayerController : MonoBehaviour
{
    ...
    public void OnDie()
    {
        ...
        UIController.Instance.Fade("dead"); //Fade ÄÚ·çÆ¾ È£Ãâ

        deathCount++; //»ç¸ÁÈ½¼ö Ãß°¡
        PlayerPrefs.SetInt("PlayerDeathCount", deathCount); //»ç¸ÁÈ½¼ö ÀúÀå

        this.enabled = false; //ÇÃ·¹ÀÌ¾î°¡ »ç¸Á ½Ã Å°ÀÔ·ÂÀ¸·Î ¿òÁ÷ÀÏ ¼ö ¾ø°Ô ÇÔ
        //PlayerReplaced();
    }
